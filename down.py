...
with open("srwy53.html", "wb") as frp:
    ...
    #url = "https://mevius.5ch.net/test/read.cgi/gamerobo/1756209337/"
    #url = "https://mevius.5ch.net/test/read.cgi/gamerobo/1756275623/"
    url = "https://mevius.5ch.net/test/read.cgi/gamerobo/1756308681"
    f = opener.open(url)
