...
set = {
    ...
    "02" : {"url_a": 'https://hon-hikidashi.jp/enjoy/161402/',
            "url_b": 'https://hon-hikidashi.jp/enjoy/161403/'}
}

url_a ='https://hon-hikidashi.jp/enjoy/156084/'
url_b = 'https://hon-hikidashi.jp/enjoy/156085/'

titles = ["女神のカフェテラス", "もののがたり", "ギルティサークル", "出会って5秒でバトル", "ぐらんぶる", "てんぷる", "バツハレ", "制裁学園", "EDENS", "イジらないで、長瀞さん", "恋愛志向生徒会", "トリアージ", "トリニティセブン", "カッコウの許嫁", "ダンダダン", "キングダム", "終末のハーレム", "はぐれアイドル", "魔都精兵のスレイブ", "あやかしトライアングル", "彼女、お借りします", "絶対聖域のチェリオン", "甘神さんちの縁結び", "俺の現実", "賭ケグルイ",  "性食鬼", "冒険王ビィト", "呪術廻戦", "さわらないで小手指くん", "化物語", "神呪のネクタール", "ダーウィンズゲーム", "チェンソーマン", "タダでは抱かれません"]
