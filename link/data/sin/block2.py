...
def read_list():
    with open("check_param_list.txt", "r", encoding="utf-8") as f:
        buf = f.read()
...
def main(in_filename, out_filename):
    ...
    param_list = read_list()
    
    print(len(process_list))
    
    for item_list in process_list:
        ret += process(item_list, param_list)
...
if __name__ == '__main__':
    ...
    main("result20250416_2_dup_normalized.tsv", "result20250416_2_dup_mark.tsv")
