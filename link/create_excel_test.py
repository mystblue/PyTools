...
#psp_list = ["DGFT", "ソニーペイメント", "ペイジェント", "GMO-PG", "SMBCファイナンス", "ヤマトフィナンシャル", "ゼウス", "SMBC-GMO", "GMO-MG", "三菱UFJニコス", "NTTコムオンライン", "楽天カード", "pay.jp", "sbps"]
...
psp_dic = {
    ...
    "sbps" : ["オーソリ", "カードチェック", "カード預かり登録", "カード預かり更新"],
}
